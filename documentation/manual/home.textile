...
bc. #{deadbolt.restrictedResource resourceKeys:['resourceA']}
...
bc. #{deadbolt.restrictedResource resourceKeys:['resourceA', 'someMetaInfo'], allowUnspecified:false}
...
bc. #{deadbolt.restrictedResource resourceKeys:['resourceA'], allowUnspecified:true}
...
bc. #{deadbolt.restrictedResource resourceKeys:['resourceA'], resourceParameters:['foo':'bar']}
...
bc. // This restricts access to the list method to any role holder, regardless of roles.
@RoleHolderPresent
public static void list()

bc. // This restricts access to the Foo controller to any role holder, regardless of roles.
@RoleHolderPresent
...
bc. // This unrestricts access to the list method, even if the method is in a restricted controller.
@Unrestricted
public static void list()

bc. // This unrestricts access to the Foo controller, even if the parent controller is restricted.
@Unrestricted
public class Foo extends Controller

Note that
* Unrestricted controllers can still have restricted methods
* Restricted controllers can have unrestricted methods
...
bc. #{deadbolt.externalizedRestriction externalRestrictions:['admin']}
...
bc. #{deadbolt.externalizedRestriction externalRestrictions:['admin', 'super-mega-admin']}
...
h3. Caching the RoleHolder on a per-request basis
...
bc. deadbolt.cache-user-per-request=true
...
bc. deadbolt.default-response-format=json
